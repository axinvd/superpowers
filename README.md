...
3. **subagent-driven-development** - Activates with plan. Dispatches scoped worker subagents per task in parallel groups, with orchestrator handling commits per group.
...
- **subagent-driven-development** - Parallel execution with scoped worker subagents
